...
export function getDataChainsFromResponse(chainsResponse: ChainsResponse[]): ChainsData[] {
  return chainsResponse.map((chainResponse) => {
    ...
    return {
      ...
      profit: {
        profit100: chainResponse.rate_100_percent ? Number(chainResponse.rate_100_percent.toFixed(2)) : null,
        profit1000: chainResponse.rate_1000_percent ? Number(chainResponse.rate_1000_percent.toFixed(2)) : null,
        profit10000: chainResponse.rate_10000_percent ? Number(chainResponse.rate_10000_percent.toFixed(2)) : null,
      },
      avgProfit: {
        profit100: chainResponse.avg_rate100_percent ? Number(chainResponse.avg_rate100_percent.toFixed(2)) : null,
        profit1000: chainResponse.avg_rate1000_percent ? Number(chainResponse.avg_rate1000_percent.toFixed(2)) : null,
        profit10000: chainResponse.avg_rate10000_percent ? Number(chainResponse.avg_rate10000_percent.toFixed(2)) : null,
      },
